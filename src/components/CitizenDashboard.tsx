...
export const CitizenDashboard: React.FC<CitizenDashboardProps> = ({ 
  ...
  const stats = [
    { label: 'Active Projects', value: projects.length.toString(), icon: Globe, color: 'text-blue-600' },
    { label: 'Tax Utilization', value: '₹4,250 Cr', icon: BarChart3, color: 'text-gov-green' },
    { label: 'Public Grievances', value: '1,240', icon: MessageSquare, color: 'text-gov-saffron' },
    { label: 'Integrity Score', value: '84/100', icon: ShieldAlert, color: 'text-gov-blue' },
  ];
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <div className="text-center">
              <p className="text-2xl font-display font-bold text-gov-saffron">₹4,250 Cr</p>
              <p className="text-[8px] font-bold uppercase tracking-widest text-white/40">Public Funds Tracked</p>
            </div>
            <div className="w-[1px] h-10 bg-white/10" />
            <div className="text-center">
              <p className="text-2xl font-display font-bold text-gov-green">84%</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="gov-card p-8 bg-gradient-to-br from-white to-slate-50">
            ...
            <div className="space-y-6">
              {[
                { label: 'Infrastructure & Roads', amount: '₹1,250 Cr', percent: 35, color: 'bg-gov-blue' },
                { label: 'Public Health & Hospitals', amount: '₹850 Cr', percent: 25, color: 'bg-gov-green' },
                { label: 'Education & Schools', amount: '₹750 Cr', percent: 20, color: 'bg-gov-saffron' },
                { label: 'Rural Development', amount: '₹400 Cr', percent: 12, color: 'bg-blue-400' },
                { label: 'Others', amount: '₹250 Cr', percent: 8, color: 'bg-slate-400' },
              ].map((item) => (
                <div key={item.label} className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="font-semibold text-slate-700">{item.label}</span>
                    <span className="font-bold text-gov-blue">{item.amount}</span>
                  </div>
          ...
          <div className="gov-card p-6 border-l-4 border-l-red-500 bg-red-50/30">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white rounded-lg border border-red-100 space-y-2">
                ...
                <p className="text-xs font-bold text-slate-800">Highway Expansion Project</p>
                <p className="text-[10px] text-slate-500">Suspicious cost escalation detected (24% above market rate).</p>
              </div>
              <div className="p-4 bg-white rounded-lg border border-slate-100 space-y-2">
                ...
                <p className="text-xs font-bold text-slate-800">Smart School Initiative</p>
                <p className="text-[10px] text-slate-500">100% fund utilization transparency verified by AI audit.</p>
              </div>
            </div>
          </div>
